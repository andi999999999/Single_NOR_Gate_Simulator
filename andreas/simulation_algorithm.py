...
def algorithm1(input_transitions: list[InputTransition], params: NORModelParams) -> list[OutputTransition]:
    ...
    while t_next < input_transitions[-1].t:
        ...
        if case == Case.A or case == Case.B or case == Case.C or case == Case.D:
            t_o = current_transition.t + case.delay_func(Vint, params) # a, b, c, d requires these 2 arguments, this could be solved more estetically i am aware, but is pragmatic
            ...
            t_o = current_transition.t + case.delay_func(Vint, params) # e, f requires these 2 arguments, this could be solved more estetically i am aware, but is pragmatic
